...
#define SIGS_PB_FILE 		 "nemo_sigs.pb.bin"
#define SPLICED_SIGS_PB_FILE "nemo_spliced_sigs.pb.bin"
#define CONS_PB_FILE 		 "nemo_connections.pb.bin"
...
class Nemo_Design{
	...
	private:
		...
		unsigned int                    num_spliced_sigs;   // number of unique signals in the design
		unsigned int                    num_conns;		    // number of unique signals in the design
		...
		void load_signals_from_pb();
		void load_spliced_signals_from_pb();
		void load_signals_from_ivl(ivl_scope_t scope);
		
		// Connection Loading Functions
		void load_connections_from_pb();
		void load_connections_from_ivl();
